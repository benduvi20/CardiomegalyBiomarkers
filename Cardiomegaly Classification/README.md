...
- Biomarker values --> https://physionet.org/content/cxr-cardiomegaly/1.0.0/ or can be generated by implementing code in folder ./Biomarkers Extraction/ on main repo page
